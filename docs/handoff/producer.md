...
<!-- digest:start -->
## Status Digest (2026-09-06 10:44 UTC)
...
**Risks:** #856 resolves the recorded runner timeout budget; per-test CI matrix reductions remain a possible improvement, not newly queued work. J2 is gated and merged. Use #860's corrected audit counts; old border counts are invalid. #866 resolves both short planks and bare paved edges. Kerb walls add cover (K2 covered share 18.2→19.3%); recorded without retuning, routes and sight reported unchanged. #849 is explicitly not solved by the diagonal piece. A 96² city save is reported at 1.5 MB; balance changes stay on #734. Inherited autofill permits wrong tiers; do not run it.
