 ...
 * `kind: "part"` nodes priced by tier (ADR 0011). The other kinds of
 * ADR 0013 §2.7 (intel, autopsy, infantry, story) carry their own
 * prices and land with the campaign content that reveals them. Tier
