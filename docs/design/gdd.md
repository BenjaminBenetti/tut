...
- **Infestation Level (0–10)** controls the approved **B — Resin Shell** treatment: level 0 retains the existing map; higher levels spread infection and select three authored stages of infested city models. Wet membranes and larvae grow around the actual walls, vehicle panels, tree trunks and rooftop equipment. Thin connected tendons join the models; level 10 infects almost every eligible tile, mixing established and consumed hosts. Water and the landed dropship hull stay clear. The Map Lab slider regenerates the same layout and shares its value in the URL. See the [production kit and progression captures](kits/resin-infestation.md).
