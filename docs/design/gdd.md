...
- The full roster spans three tiers: affordable field equipment, specialists, and capital-grade systems. All parts remain available for credits until the later tech-tree project. Six example blueprints in the bay demonstrate complete legal builds; loading a blueprint changes the draft without purchasing it.
