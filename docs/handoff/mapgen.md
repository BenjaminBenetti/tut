...
Last updated: 2026-09-09 (Astra 6 seat; #960 final generation/evidence; #1042 rebased/pushed once; #1005 Art-owned). Read this entry before the historical notes.

## Current seat status


- **Current override:** normal sequencing resumed at 01:08; older merge-pause/queue notes below are historical. #1006/#1052, #984/#1053 and Art's #1043/#1055 are merged. #1005 production belongs to Art. #869 belongs to eng-3 with MapGen's exact-crossed-half-wall approval, preserving pass order; submitted #1063. After #960, take #591 measurement/design only. No tree-opacity change is authorized.
- **#1042 interruption completed:** accepted `9b8575c` rebased onto main `b4acf3f`, pushed once as `a7e7a22`; the derived-entrance fixture is byte-identical. Current eight-seat distinct-capacity and dropship contracts both survive. Two #1052 wheel steps/torso targeting retained; six combined ASCII goldens measured anew. Typecheck, conflict-focused lint/format, 88 units, 216-map sweep/determinism/goldens and five browser tests pass, zero retries. TL confirmed clean merge and began its gate in 5595033390; its fresh combined-runtime capture remains required. Historical accepted PNGs unchanged. MapGen returned to #960 in the same turn.
- **#960 active:** branch `feat/960-building-yard-arrangements`, base `8d20dd4`. Art's actual bench from #1060 is integrated with original authorship (`e92cd27`/`830ebdd`, cherry-picked here); no placeholder remains. Two development regressions were exposed by the existing objective tests: changing hook pools before hooks gave 14 turns to first shot; a bench then isolated an outdoor firing approach. The final pass runs after hooks/boundaries and before connectivity, protects hatch/deploy/door/connector space and window staging, and requires short local paths around each group for both classes. The eight arrangement/engagement tests pass; the recorded firing seed is now explicit on CI too. 108 independently paired maps retain hooks, terrain, walls, buildings, roads, connectors and all non-target props; all 36 rural complete maps match. Original baseline hashes match every re-generated baseline. Town targeted yard clutter 1003→317 contextual props; city 2171→519. Full gates and final actual-model captures are in progress; no final frame judgment/merge claim yet. Provisional pre-access-fix after frames are scratch only.
...
- **Standing orders 23:57 UTC:** merges are paused because Tech Lead reached Fable's weekly limit. This is **not a work hold**: keep working/pushing, submit evidence even if Director goes quiet, then take the next queued ticket. No model switches/retooling. Map Critic resumed at 23:53 and is re-checking merged #945/#959; its old stopped-watch status is superseded. Focus remains tactical UX and map generation.
