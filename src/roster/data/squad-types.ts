...
export const RADIO_SQUAD: SquadType = {
  ...
  combatRating: 28,
  description:
    "Signals infantry with SMGs and portable radar. One hard-hitting burst a turn at short range. Deploy a scanner on an adjacent free tile for 1 AP: hidden enemies and egg nests appear as red blips within a 30-tile circle for the rest of the mission.",
