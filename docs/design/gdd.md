...
- Tech points buy nodes of the **tech tree** (the Tech screen): six family columns (mobility, protection, ballistics, energy, fire support, support), tier 2 nodes over tier 3 nodes, each node naming its cost and the parts it makes purchasable. A card is unlocked, available, unaffordable (`Need N more TP`) or locked (`Requires <node>`); tier 3 needs its family's tier 2 rung.
