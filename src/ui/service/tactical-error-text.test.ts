...
const EVERY_KIND: readonly TacticalError[] = [
  ...
  { kind: "no-equipment", unitId: ID, equipmentId: "grenade" },
  ...
  { kind: "illegal-burrow", unitId: ID, reason: "cooldown" },
  { kind: "unit-burrowed", unitId: ID },
  { kind: "target-burrowed", targetId: ID },
