...
- **Watcher triage:** #916 already belongs to Art (`fix/916-nonwalkable-roofs`); do not duplicate it. #917 is an evidenced p2 rural-fence placement ticket, queued after the directly assigned #910 → #915 sequence. It has been read; no implementation started.
