 ...
 * tune them in the preview harness, not in passes. Building weights favour
 * playable commercial variety: homes and apartments share a residential
 * budget, with comparable room for shops and workplaces.
 */
export const BIOME_DEFINITIONS: Readonly<Record<BiomeId, BiomeDefinition>> = {
  temperate: {
    ...
    buildingKinds: [
      { template: BuildingKindIds.HOUSE, weight: 2 },
      { template: BuildingKindIds.APARTMENT, weight: 1 },
      { template: BuildingKindIds.SHOP, weight: 4 },
      { template: BuildingKindIds.WAREHOUSE, weight: 1 },
      { template: BuildingKindIds.TOWER, weight: 3 },
    ],
