 ...
 * the biome's vegetation around the site comes from the settlement's
 * prop pass, which since #714 can be asked for scattering without also
 * being asked for interiors.
 *
