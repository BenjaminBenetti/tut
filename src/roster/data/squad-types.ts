...
export const ENGINEER_SQUAD: SquadType = {
  ...
  combatRating: 28,
  description:
    "Combat engineers with shotguns, tools and demolition charges: two blasts a turn at arm's length, nothing at range. Invaluable around objectives. Carries a repair kit: twice a mission, every mech in a grenade's footprint gets 25 hit points back. Carries two turrets a mission: deploy one on a free tile within 2 tiles for 1 AP, and it stands on overwatch for 3 turns, two rifle-strength shots a turn, before it burns out.",
  equipment: [GRENADE.id, REPAIR_KIT.id, TURRET.id],
};
