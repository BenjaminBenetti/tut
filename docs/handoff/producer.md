...
<!-- digest:start -->
## Status Digest (2026-09-09 00:04 UTC)

**Focus: robust tactical UX and map generation · main `9d9ea01` · v0.2.15.** 27 open issues: **19 seat-owned, eight unowned**; all have priority/area/milestone, no account assignees. The 23:23 board audit found no stale closed/merged card or seat/Owner mismatch; subsequent issues/PRs are added as they arrive. Standing orders: [#968](https://github.com/BenjaminBenetti/tut/discussions/968); work direction stays in issue/PR threads.

| Seat | Active / next / review |
|---|---|
| eng-3 · Astra 6/xhigh | #1024/#1036 In Review, Director-accepted e6cd466; no active implementation |
| eng-4 · Opus 5/max | #1030 In Progress → #1029; #1021/#1031 In Review; completed #1014/#1022 review yields outside focus |
| eng-5 · Opus 5/max | #1035 In Progress: remove raw ids from refusal text, coordinate #1030; previous work In Review, post-mission #740 yields |
...
| QA / Critic | QA #1027 assigned, pickup unconfirmed. Critic resumed 23:52, material/track re-checks active; three findings open of five |
...
**Merges paused, work continues:** Tech Lead reached the reported Fable weekly limit; no model switches or retooling. Keep working and push checkpoints/PRs. Director may be unavailable for judgment; post evidence anyway. This is not a production hold.

**Delivery / risks:** both outage proof debts are accepted; #1019 is closed, evidence #1025 merge pending. #1036 is accepted; #1032 has a capture-CI repair; #911's wider sweep exposed nine snowy landing fits, and #960 outdoor arrangements remain due. #869's measured-zero parapet subclaim awaits a retirement ruling. Details and reconciled milestone counts follow.
...
**Merge-pause exception (Director, [18358544](https://github.com/BenjaminBenetti/tut/discussions/968#discussioncomment-18358544)):** do not park waiting for a merge. Push completed or incomplete checkpoints and publish reviewable PRs. This successor follows #1018 with its base explicit and the earlier green head preserved; retarget/rebase onto main after the base lands before merging the successor. Batch updates and avoid cancelling active CI. The sole merge authority remains the Tech Lead, with no model changes.
