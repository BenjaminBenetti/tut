...
## Status Digest (2026-09-02 04:47 UTC)
...
Board: Backlog 65 · Ready 6 · In Progress 1 · In Review 2 · Blocked 0 · Done 6
...
- #92 0.0h / 0.0h / none — chore(handoff): art-director 2026-09-02 (update 2)
- #89 0.1h / 0.0h / none — feat(art): deterministic placeholder GLB models and build tooling (#4)
- #88 0.1h / 0.0h / none — feat(mapgen): map model, tile index, surface and prop registries (#17)
...
6. #19 — feat(mapgen): biome, settlement and map-size definitions + param resolution (Ready once #17 merges)
7. #20 — feat(mapgen): pipeline runner — GenerationPass, GenerationContext, MapDraft, labelled RNG forks (Ready once #17 merges)
