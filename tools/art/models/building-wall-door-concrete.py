"""City kit: door wall in the concrete family."""
...
from city_kit_parts import CONCRETE, CORNICE_HEIGHT, CORNICE_THICKNESS, WALL_HEIGHT, WALL_LENGTH, door_opening  # noqa: E402
...
def build() -> None:
    ...
    bevel(cornice, 0.015)
    door_opening(material=CONCRETE)
    socket("door", (0, 0, 0))
