...
export const RADIO_SQUAD: SquadType = {
  ...
  combatRating: 28,
  description:
    "Signals infantry with portable radar. Deploy a scanner on a free tile within 2 tiles for 1 AP: hidden enemies and egg nests appear as red blips within a 30-tile circle for 3 turns, until its battery burns out.",
